...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        # self.num_heads = min(num_heads, dim // 2)
    ...
    def forward(self, x, mask=None):
        ...
        # print("==============================")
        # print("Before qkv operation, x shape:", x.shape)
        # print("==============================")
        # print("Additional Info:")
        # print("Batch size (B_):", B_)
        # print("Number of tokens (N):", N)
        # print("Number of channels (C):", C)

        # qkv = self.qkv(x)
        # print("Shape after qkv projection:", qkv.shape)
        qkv = self.qkv(x).reshape(B_, N, 3, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)
        # print("Shape after reshaping and permuting:", qkv.shape)
