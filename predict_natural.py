...
def get_args():
    ...
    parser.add_argument('--model',          '-m',  default='/home/fyp1/ChengYuxuan/UNetMilesial-MedSegDiff/checkpoints/checkpoint_epoch10.pth')
    parser.add_argument('--input',          '-i',  default='/home/fyp1/carvana-image-masking-challenge/test_hq/',   help='input images file')
